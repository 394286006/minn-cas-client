...
import p.minn.security.auth.MyPasswordEncoder;
...
public class AccountService implements IAccountService{
	...
	public List<Map<String,Object>> getAccountRole( String lang, String messageBody) throws Exception{
		...
		List<Map<String,Object>> target=UtilCommon.createTreeMenu(list,"-2");
		list=target;
	...
	public void update(User user,String messageBody, String lang) {
		// TODO Auto-generated method stub
		Account account =(Account) UtilCommon.gson2T(messageBody, Account.class);
		...
		account.setPwd(UtilCommon.getPwd(account.getPwd()));
	...
	public void saveAccountRole(String messageBody) {
		// TODO Auto-generated method stub
		 Map map=(Map) UtilCommon.gson2T(messageBody,Map.class);
